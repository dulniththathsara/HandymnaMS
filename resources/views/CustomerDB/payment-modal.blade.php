...
>
  <div class="w-[1300px] max-w-full rounded-2xl shadow-2xl p-10 bg-[#101b2b] relative">
    ...
    <button @click="showPayment = false" 
            class="absolute top-4 right-6 text-white text-2xl font-bold hover:text-orange-400 transition">
      &times;
    </button>
    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div class="col-span-2">
        ...
        <input type="text" placeholder="1234 5678 9012 3456"
          class="w-full px-5 py-3 rounded-full bg-[#262626] text-white border border-gray-700 placeholder-gray-400 
      ...
      <div>
        ...
        <input type="month"
          class="w-full px-5 py-3 rounded-full bg-[#262626] text-white border border-gray-700 
                 focus:outline-none focus:ring-2 focus:ring-orange-500">
      </div>
    ...
    <div class="mt-8 text-right">
      <button
        class="bg-gradient-to-r from-[#f2550c] to-[#f79c45] hover:from-orange-500 hover:to-orange-300 
               text-white font-semibold py-2 px-10 rounded-full transition duration-300">
        Pay Now
      </button>
    </div>
